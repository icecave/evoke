<?php
namespace Icecave\Evoke\TypeCheck\Exception;

final class UnexpectedArgumentValueException extends UnexpectedInputException
{
    public function __construct($parameterName, $index, $value, $expectedType, \Exception $previous = null, \Icecave\Evoke\TypeCheck\TypeInspector $typeInspector = null)
    {
        if (null === $typeInspector) {
            $typeInspector = new \Icecave\Evoke\TypeCheck\TypeInspector();
        }

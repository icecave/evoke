...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Evoke\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Evoke\\TypeCheck'), false);
    }
